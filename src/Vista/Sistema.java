...
public final class Sistema extends javax.swing.JFrame {
    ...
    public void ListarConfig() {
        conf = proDao.BuscarDatos();
         System.out.println("Teléfono obtenido: " + conf.getTelefono());
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/I (1).png"))); // NOI18N
        ...
        TableCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "DNI/CUIT", "NOMBRE", "TELÉFONO", "DIRECCIÓN"
            }
        ));
        ...
        TableProveedor.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "CUIT", "NOMBRE", "TELÉFONO", "DIRECCIÓN"
            }
        ));
        ...
        jPanel7.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 420, 310));
        ...
        LabelVendedor.setText("ImporTuc");
        getContentPane().add(LabelVendedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 80, 200, -1));
