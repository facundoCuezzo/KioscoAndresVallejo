...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        txtCorreo.setText("angel@gmail.com"); //ESTO DEBEMOS EDITAR Y CAMBIAR EL MAIL
        txtPass.setText("admin");   // ESTO TAMBIEN!!
    }
    public void validar(){
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/I (1).png"))); // NOI18N
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, 100, 100));

        jLabel8.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("Importados Tucumán");
        ...
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, 160, 89));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // BOTON A MIRA MI PAGINA WEB o OTRAS REDES
      /*  try {
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        try {
            Desktop.getDesktop().browse(new URI("https://www.facebook.com/profile.php?id=100010168516392"));
        } catch (IOException | URISyntaxException e1) {
        }
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        // TODO add your handling code here:
        try {
            Desktop.getDesktop().browse(new URI("https://www.instagram.com/facu_cuezzo/"));
        } catch (IOException | URISyntaxException e1) {
        }
